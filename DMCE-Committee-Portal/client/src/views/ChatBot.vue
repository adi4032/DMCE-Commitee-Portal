...
<template>
  <div
    class="justify-between items-center min-h-screen w-full rounded-xl gap-6 p-2"
    id="chat_background"
  >
    <div class="flex flex-col gap-6 w-full h-full" id="chat">
    ...
    <form class="relative w-full" @submit.prevent="Input_Chat">
      <input
        type="text"
        class="block p-4 w-full bg-gray-50 rounded-2xl focus:outline-none"
      ...
      <button
        type="submit"
        class="text-[#fff] absolute right-2 bottom-1.5 bg-[#121212] hover:bg-[#121212]/90 rounded-xl px-5 py-2.5"
      >
        Send
      </button>
    </form>
